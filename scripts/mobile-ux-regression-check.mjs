...
assert.equal(overrides.includes('mobile-overwhelm-repair.css'), true, 'The final mobile UX repair stylesheet must load last.')
...
assert.equal(tradeLayer.includes('<details className="discussion-section planning-tool-panel planning-trade-panel">'), true, 'Trade details must use progressive disclosure.')

console.log('Mobile UX regression check passed: one undocked hand, one official Magnifier, normalized setup cards, and condensed planning.')
