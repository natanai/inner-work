...
try {
  ...
  const { continueRound, createGame, resolveRound } = await server.ssrLoadModule('/src/tabletop/model.ts')
  const { enabledSpecialActionIds, specialActionById } = await server.ssrLoadModule('/src/tabletop/specialActions.ts')
