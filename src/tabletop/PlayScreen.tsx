...
export function PlayScreen({ game, onChange, onNextSituation, onEnd }: { game: GameState; onChange: (game: GameState) => void; onNextSituation: () => void; onEnd: () => void }) {
  ...
  const playerIdentity = cognitionIdentity(player)
